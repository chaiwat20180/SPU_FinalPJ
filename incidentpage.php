            ...
            <div class="container">
              <div class="row">
                <?php
                    ...
                    while ($show_TicketData = $query_tyepe_ticket->fetch(PDO::FETCH_ASSOC)) {
                ?>
                <div class="col-lg-4">
                  <div class="card p-4" style="width: 18rem;">
                    <img class="card-img-top p-4" src="../asset/category_pic/<?php echo $show_TicketData['Category_Pic']; ?>" alt="Category Poc">
                    <div class="card-body">
                      <h5 class="card-title"><?php echo $show_TicketData['Category_Name'];?></h5>
                      <p class="card-text d-inline-block text-truncate" style="max-width: 300px;" ><?php echo $show_TicketData['Category_Description']; ?></p><br>
                      <a href="formrequest.php?type=<?php echo $show_TicketData['Category_Type']; ?>&catgory_id=<?php echo $show_TicketData['Category_ID'];?>" class="btn btn-primary">Click Request</a>
                    </div>
                  </div>
                </div>
                <?php 
