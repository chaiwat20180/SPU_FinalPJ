<?php
   ...
   if(@$_SESSION['Emp_ID'] != "" && $_GET['status_id'] != ""){
   ?>
         ...
         <div class="content-wrapper mt-5 p-4">
            ...
            <section class="content">
               <div class="container-fluid p-4 bg-white rounded">
                  ...
                  <div class="row p-4" >
                  <div class="container">
                  <a href="list_status.php" class="btn btn-danger mb-4"><i class="fas fa-reply"></i> Back</a>
                     <div class="row d-flex justify-content-center">
                        <div class="col-lg-6">
                           <?php
                              $get_groupId = $_GET['status_id'];
                              $query_last_data_value = $db_connect->prepare("
                                 ...
                                 WHERE
                                       tbs.Status_ID   = :Status_ID  

                              ");
                              $query_last_data_value->bindParam(':Status_ID', $get_groupId);
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="sta" name="statusID" value="<?php echo $last_data['Status_ID']; ?>" disabled>
                           </div>
                           <div class="form-group">
