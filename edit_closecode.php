<?php
   ...
   if(@$_SESSION['Emp_ID'] != "" && $_GET['close_code'] != ""){
   ?>
                           ...
                           <div class="col-lg-6">
                              <?php
                                 ...
                                 $query_last_data_value = $db_connect->prepare("
                                    ...
                                    FROM
                                          tbclose_code tbcc
                                    LEFT JOIN tbemployee tbemp ON tbemp.Emp_ID = tbcc.UpdatedBy
                                    WHERE
                                          tbcc.Close_Code_ID  = :Close_Code_ID

                                 ");
                                 $query_last_data_value->bindParam(':Close_Code_ID', $close_code);
                              ...
                              <div class="form-group">
                                 ...
                                 <input type="text" class="form-control" id="closecodeid"  placeholder="Close Code ID" value="<?php echo $last_data['Close_Code_ID']; ?>" disabled>
                              </div>
                              <div class="form-group">
                                 <label for="Location"><?php echo $text_add_close_code_name ?></label>
                                 <input type="text" class="form-control" id="inputclosecodename" name="close_code_name" placeholder="Location" value="<?php echo $last_data['Close_Code_Name']; ?>" required>
                              </div>
                              <div class="form-group">
                                 <div class="mt-5 ml-auto">
                                    <div class="row d-flex justify-content-end">
                                       <div class="col-sm-12 col-lg-2">
                                          <button type="submit" name="editcc" class="btn btn-primary w-100"><i class="far fa-save"></i> <?php echo $text_save ?></button>
                                       </div>
                                    </div>
                                 </div>
                              </div>
