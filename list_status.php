            ...
            <section class="content">
               <div class="container-fluid p-4 bg-white rounded">
                  <div class="row">
                                    ...
                                    <div class="modal-content">
                                       ...
                                       <form action="<?php $_SERVER['PHP_SELF']; ?>" method="post">
                                                ...
                                                <div class="row">
                                                   <div class="col-lg-12">
                                                      <div class="form-group">
                                                         <label for="Location"><?php echo $text_add_status ?></label>
                                                         <input type="text" class="form-control" id="inputstatusname" name="status" placeholder="Status. name" required>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
                                          ...
                                          <div class="modal-footer">
                                             ...
                                             <button type="submit" name="addstatus" class="btn btn-primary"><?php echo $text_add_site ?></button>
                                          </div>
                                       </form>
                                    </div>
                                 </div>
                     ...
                     <div class="col-lg-6">
                        <form action="/list_status.php" method="get">
                                       ...
                                       <td>
                                          <div class="row">
                                             <div class="col-lg-12 p-2">
                                                <a class="btn btn-block btn-primary" href="edit_status.php?status_id=<?php echo $show_groupData['Status_ID']; ?>">
                                                ...
                                                <div class="modal-content">
                                                   ...
                                                   <div class="modal-body">
                                                      ...
                                                      <div class="modal-footer">
                                                         ...
                                                         <a class="btn btn-danger delete-btn" data-id="<?php echo $show_groupData['Status_ID']; ?>"><?php echo $text_delete ?></a>
                                                      </div>
                                                   </div>
                                                </div>
                                             </div>
      ...
      <script>
         $(document).ready(function(){
            ...
            // var siteId = $(this).data('id');
             var Status_ID = $(event.target).attr('data-id');
            $.ajax({
               type: 'POST',
               url: 'config/event/delete_status.php',
