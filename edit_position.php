<?php
   ...
   if(@$_SESSION['Emp_ID'] != "" && $_GET['position_id'] != ""){
   ?>
         ...
         <div class="content-wrapper mt-5 p-4">
            ...
            <section class="content">
               <div class="container-fluid p-4 bg-white rounded">
                  ...
                  <div class="row p-4" >
                  <div class="container">
                  <a href="list_position.php" class="btn btn-danger mb-4"><i class="fas fa-reply"></i> Back</a>
                     <div class="row d-flex justify-content-center">
                        <div class="col-lg-6">
                           <?php
                              $get_positionId = $_GET['position_id'];
                              $query_last_data_value = $db_connect->prepare("
                                 ...
                                 FROM
                                       tbposition tbp
                                 WHERE
                                       tbp.Position_ID   = :Position_ID 

                              ");
                              $query_last_data_value->bindParam(':Position_ID', $get_positionId);
                           ...
                           <div class="form-group">
                              ...
                              <input type="text" class="form-control" id="positionID" name="groupID" value="<?php echo $last_data['Position_ID']; ?>" disabled>
                           </div>
                           <div class="form-group">
                              <label for="Site Name"><?php echo $text_add_assigngroup ?></label>
                              <input type="text" class="form-control" id="inputgroupname" name="positionname" placeholder="Group. Name" value="<?php echo $last_data['Position_name']; ?>" required>
                           </div>
                           <div class="mt-5 ml-auto">
                                 <div class="row d-flex justify-content-end">
                                    <div class="col-sm-12 col-lg-2">
                                       <button type="submit" name="editposition" class="btn btn-primary w-100"><i class="far fa-save"></i> <?php echo $text_save ?></button>
                                    </div>
                                 </div>
                              </div>
                        </div>
